...
<head>
	...
	<body>
		...
		<div class="main-page-wrapper">
					...
					<div class="row clear-fix">
						<div class="col-md-6 col-xs-12">
							<ul class="top-header-left clear-fix">
								<li><a href="#"><i class="fa fa-map-marker" aria-hidden="true"></i>Al-sheikh St, Al-Noflieen, Tripoli-Libya</a></li>
								<li><a href="#"><i class="fa fa-envelope-o" aria-hidden="true"></i> info@noormed.com</a></li>
							</ul>
						</div>
						<div class="col-md-6 col-xs-12">
									...
									<nav class="navbar">
										...
										<div class="collapse navbar-collapse" id="navbar-collapse-1">
											<ul class="nav navbar-nav">
												<li class="dropdown-holder active current-page-item Active-manu"><a href="index-3.html"> Home </a>
												</li>
												...
												<li class="dropdown-holder"><a>Divisions</a>
													<ul class="sub-menu">
														<li><a href="product.html" class="tran3s">PHARMACEUTICALS</a></li>
				...
				<div id="theme-main-banner">
					<div data-src="images/home/banner-slider-2.jpg">
						<div class="camera_caption">
							<div class="container">
							    <h1 class="wow fadeInUp animated"> Noor Al-Amana Company</h1>
							    <p class="wow fadeInUp animated"  data-wow-delay="0.5s">NA is one of the fastest growing and most innovative ranges of <br>generic medicines in Libya.</p>
 							</div> <!-- /.container -->
						</div> <!-- /.camera_caption -->
					</div>
					<div data-src="images/home/banner-slider-1.jpg">
						<div class="camera_caption">
							<div class="container">
							    ...
							    <p class="wow fadeInUp animated"  data-wow-delay="0.5s">Launched in Libya in 2018,NA has expanded rapidly to become <br> covers the most area in Libya.</p>
					...
					<div data-src="images/home/banner-slider-3.jpg">
						<div class="camera_caption">
							<div class="container">
							    ...
							    <p class="wow fadeInUp animated"  data-wow-delay="0.5s">NA imports high quality generic medicines in awide <br>and growing range of therapeutic categories.</p>
			...
			<section class="home-business-section home-two-business" hidden>
				<div class="container">
					<div class="business-text">
						<p>Our many years of experience in business make us<br>expers at enabling you to gain insight into your life<br>and into your business.</p>
						<span></span>
					</div>
					<div class="row">
						<div class="col-sm-4 col-xs-12">
							<div class="business-item">
								<div><img src="images/Them-logo/icon-3.png" alt="icon"></div>
								<h5><a href="#">Market Strategy</a></h5>
						...
						<div class="col-sm-4 col-xs-12">
							<div class="business-item">
								<div><img src="images/Them-logo/icon-4.png" alt="icon"></div>
								<h5><a href="#">Expert Advisor</a></h5>
								<p>We have experience 10 years providing business solution & with our top expert lorem ipsum gain qulity checker with your business.</p>
							</div>
						</div>
						<div class="col-sm-4 col-xs-12">
							<div class="business-item">
								<div><img src="images/Them-logo/icon-5.png" alt="icon"></div>
								<h5><a href="#">Audit & Consulting</a></h5>
								<p>We have experience 10 years providing business solution & with our top expert lorem ipsum gain qulity checker with your business.</p>
							</div>
						</div>
					</div>
			...
			<section class="home-two-our-service clear-fix" hidden>
				<div class="home-two-our-service-item float-left">
					<img src="images/home/img-12.jpg" alt="image">
					<div class="item-opact-text">
						<h5><a href="#">Training Coach <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></h5>
						<p>We have experience 10 year providing quick business solution & with our top expert lorem ipsum gain qulity checker with your business</p>
					</div>
				</div>
				<div class="home-two-our-service-item float-left">
					<img src="images/home/img-13.jpg" alt="image">
					<div class="item-opact-text">
						<h5><a href="#">High Selling <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></h5>
						<p>We have experience 10 year providing quick business solution & with our top expert lorem ipsum gain qulity checker with your business</p>
					</div>
				</div>
				<div class="home-two-our-service-item float-left">
					<img src="images/home/img-13.jpg" alt="image">
					<div class="item-opact-text">
						<h5><a href="#">Consultive Selling <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></h5>
						<p>We have experience 10 year providing quick business solution & with our top expert lorem ipsum gain qulity checker with your business</p>
					</div>
				</div>
				<div class="home-two-our-service-item float-left">
					<img src="images/home/img-14.jpg" alt="image">
					<div class="item-opact-text">
						<h5><a href="#">Sell Negotiation <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></h5>
						<p>We have experience 10 year providing quick business solution & with our top expert lorem ipsum gain qulity checker with your business</p>
					</div>
				</div>
			</section> 
					...
					<div class="experts-claider-wrapper">
						<div id="home-two-experts-carousel" class="owl-carousel owl-theme">
							<div class="item text-center">
								<div>
									<div class="expert-img"><img src="images/home/img-15.jpg" alt="image"></div>
									<h5><a href="https://www.kernpharma.com/es" target="_blank" >KERN</a></h5> 								</div>
							</div> <!-- / .Item -->
							<div class="item text-center">
								<div>
									<div class="expert-img"><img src="images/home/img-16.jpg" alt="image"></div>
									<h5><a href="http://www.sanochemia.at/" target="_blank">Sanochemia</a></h5>
 								</div>
							</div> <!-- / .Item -->
							<div class="item text-center">
								<div>
									<div class="expert-img"><img src="images/home/img-17.jpg" alt="image"></div>
									<h5><a href="http://www.centrafarm.nl" target="_blank">Centrafarm</a></h5>
 								</div>
							</div> <!-- / .Item -->
							<div class="item text-center">
								<div>
									<div class="expert-img"><img src="images/home/img-21.jpg" alt="image"></div>
									<h5><a href="http://www.fresenius-kabi.com" target="_blank">FRESENIUS KABI</a></h5>
 								</div>
							</div> <!-- / .Item -->
							<div class="item text-center">
								<div>
									<div class="expert-img"><img src="images/home/img-22.jpg" alt="image"></div>
									<h5><a href="http://www.stada.com" target="_blank">STADA</a></h5>
 								</div>
							</div> <!-- / .Item -->
							<div class="item text-center">
								<div>
									<div class="expert-img"><img src="images/home/img-23.jpg" alt="image"></div>
									<h5><a href="http://www.piramal.com" target="_blank">Piramal</a></h5>
 								</div>
							</div> <!-- / .Item -->
							<div class="item text-center">
								<div>
									<div class="expert-img"><img src="images/home/img-24.jpg" alt="image"></div>
									<h5><a href="http://www.recordati.com" target="_blank">BOUCHARA<br>RECORDAIT</a></h5>
 								</div>
							</div> <!-- / .Item -->
							<div class="item text-center">
								<div>
									<div class="expert-img"><img src="images/home/img-25.jpg" alt="image"></div>
									<h5><a href="http://www.basi.pt" target="_blank">Basi</a></h5>
 								</div>
							</div> <!-- / .Item -->
							<div class="item text-center">
								<div>
									<div class="expert-img"><img src="images/home/img-26.jpg" alt="image"></div>
									<h5><a href="http://www.elpen.gr" target="_blank">ELPEN</a></h5>
 								</div>
							</div> <!-- / .Item -->
							<div class="item text-center">
								<div>
									<div class="expert-img"><img src="images/home/img-27.jpg" alt="image"></div>
									<h5><a href="http://cs-diagnostics.com" target="_blank">CS-Diagnostics</a></h5>
 								</div>
							</div> <!-- / .Item -->
							<div class="item text-center">
								<div>
									<div class="expert-img"><img src="images/home/img-28.jpg" alt="image"></div>
									<h5><a href="http://www.oxmedinternational.com" target="_blank">OX Med</a></h5>
 								</div>
							</div> <!-- / .Item -->
						</div>
					</div>
			...
			<!-- What client say -->
			<section class="home-client-claider" hidden>
				<div class="container">
					<div class="them-main-title text-center">
					...
					<div class="client-claider-wrapper">
						<div id="client-claider-carousel" class="owl-carousel owl-theme">
							<div class="item">
								<div>
									<p>Having never worked with a life coach before, I really did not know what to expect. Wow, was I surprised! I found out I could make it whatever I needed.</p>
									<div>
										<span></span>
										<img src="images/Them-logo/icon-6.png" alt="logo">
										<h6><a href="#">Roman Empire</a></h6>
							...
							<div class="item">
								<div>
									<p>Duis aute irure dolor in reprehenderit in voluptate lit esse cillum dolore eu fugiat nulla pariatur. Excepteuri sint occaecat cupidatat non proident.</p>
									<div>
										<span></span>
										<img src="images/Them-logo/icon-6.png" alt="logo">
										<h6><a href="#">Mahfuz Riad</a></h6>
										<i>Co-Founder of UnifyTheme</i>
									</div>
								</div>
							</div> <!-- / .Item -->
							...
							<div class="item">
								<div>
									...
									<div>
										<span></span>
										<img src="images/Them-logo/icon-6.png" alt="logo">
										<h6><a href="#">Abdur Rob</a></h6>
										<i>Co-Founder of UnifyTheme</i>
									</div>
								</div>
							</div> <!-- / .Item -->
						</div>
					</div>	<!-- / .Home Client Claider -->
				</div>
			</section>

			<!-- Home two Recent work ____________________________ -->
			 <section class="Recent-work-section" hidden>
				<div class="container">
					<div class="row">
						...
						<div class="col-md-9 col-xs-12">
							<div class="Recent-work-claider-wrapper">
								<div id="Recent-work-claider-carousel" class="owl-carousel owl-theme">
									<div class="item">
										<div><img src="images/home/img-18.jpg" alt="image"></div>
									</div>  
									<div class="item">
										<div><img src="images/home/img-19.jpg" alt="image"></div>
									</div> 
									<div class="item">
										<div><img src="images/home/img-20.jpg" alt="image"></div>
									</div> 
									<div class="item">
										<div><img src="images/home/img-19.jpg" alt="image"></div>
									</div> 
			...
			<section class="numver-section" hidden>
	...
	<!-- Last news -->
	<section class="home-latest-news" hidden>
		<div class="container">
			<div class="them-main-title text-center">
				<h2>Latest News</h2>
				<span></span>
			...
			<div class="row news-item-wrapper">
				<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="news-item">
						<div class="news-item-img">
							<img src="images/home/img-9.jpg" alt="image">
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="news-item">
						<div class="news-item-img">
							<img src="images/home/img-10.jpg" alt="image">
							<span>07 JUN, 2019</span>
						</div>
						<div class="news-text-item">
							<h4>Business Growth Depends<br>on Your Marketing</h4>
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="news-item">
						<div class="news-item-img">
							<img src="images/home/img-11.jpg" alt="image">
							<span>07 JUN, 2019</span>
						</div>
						<div class="news-text-item">
							<h4>Business Growth Depends<br>on Your Marketing</h4>
			...
			<!-- Home Form Section ____________________________ -->
			 <section class="home-form-section" hidden>
			...
			<!-- home Logo Slide ____________________________ -->
			 <section class="home-logo-slide" hidden>
				<div class="container">
					<div class="row">
						<div class="col-md-3 col-xs-12">
							<div class="them-main-title">
						...
						<div class="col-md-8 col-xs-12">
							<div class="logo-claider-wrapper">
								<div id="logo-claider-carousel" class="owl-carousel owl-theme">
									<div class="item">
										<div>
											<img src="images/home/slide-logo-1.jpg" alt="logo">
										</div>
									</div> 
									
									<div class="item">
										<div>
											<img src="images/home/slide-logo-2.jpg" alt="logo">
										</div>
									</div>  
									<div class="item">
										<div>
											<img src="images/home/slide-logo-3.jpg" alt="logo">
										</div>
									</div>  
								</div>
							</div>  
						...
						<div class="row">
							<div class="col-md-4 col-xs-6 footer-item">
								<div class="footer-item-one">
									<p>NA - Noor Al-Amana <br> Pharmaceuticals &amp; Medical Supplies l.t.d .</p>
									<ul hidden>
										<li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
										<li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
										<li><a href="#"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
							...
							<div class="col-md-4 col-xs-6 footer-item">
								<div class="footer-item-two">
									...
									<ul>
										<li><i class="fa fa-angle-right" aria-hidden="true"></i><a>Tel +218 21 340 7995</a></li>
										<li><i class="fa fa-angle-right" aria-hidden="true"></i><a>Fax +218 21 340 7821 </a></li>
									</ul>
								</div>
							</div>
							...
							<div class="col-md-4 col-xs-6 footer-item">
								<div class="footer-item-two">
									<h3>Our Address</h3>
									<ul>
										<li><i class="fa fa-angle-right" aria-hidden="true"></i><a> Al-Sheikh St, Al-Noflieen, Tripoli-Libya</a></li>
										<li><i class="fa fa-angle-right" aria-hidden="true"></i><a> Misrata</a></li>
                                        <li><i class="fa fa-angle-right" aria-hidden="true"></i><a> Banghazi</a></li>
                                        <li><i class="fa fa-angle-right" aria-hidden="true"></i><a> AL-zawyah</a></li>
									</ul>
								</div>
							</div>
						</div>
