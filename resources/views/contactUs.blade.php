...
<head>
		...
		<link rel="stylesheet" href="css/responsive.css">
				<!-- <link rel="stylesheet" href="vendor/bootstrap-select-1.10.0/dist/css/bootstrap-select.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous"> -->
									...
									<nav class="navbar">
										...
										<div class="collapse navbar-collapse" id="navbar-collapse-1">
											<ul class="nav navbar-nav">
												...
												<li class=" active current-page-item Active-manu"><a href="contact-us.html">Contact Us</a></li>
											</ul>
										</div><!-- /.navbar-collapse -->
									</nav>
								</div> <!-- /.main-menu -->
