...
<head>
	...
	<style>
        .Enar-page-banner {
	background: url(images/home/product.jpg) no-repeat center;
							...
							<div class="col-md-8 col-xs-3 th-main-menu-vtwo-width">
								...
								<div class="main-menu theme-main-menu">
									...
									<nav class="navbar">
										...
										<div class="collapse navbar-collapse" id="navbar-collapse-1" hidden>
											<ul class="nav navbar-nav">
												<li><a href="index-3.html"> Home </a>
												</li>
												<li><a href="about-us.html" class="tran3s">About Us</a></li>
                                                
                                                 <li class="dropdown-holder"><a href="media.html">Media</a></li>


												<li class="dropdown-holder active current-page-item Active-manu"><a>products</a>
													<ul class="sub-menu">
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-9 col-md-8 col-xs-12">
							<div class="Shop-section-item-wrapper">
								<div class="row">
									<div class="col-md-4 col-sm-6 col-xs-6 shop-item-width">
										<div class="single-item-Wrapper">
											...
											<div class="single-Text-item">
												...
												<a href="single-products.html" class="hvr-bounce-to-right">ADD TO CART</a>
											</div>
										</div> <!-- /.single-item-Wrapper-->
									</div>

									<div class="col-md-4 col-sm-6 col-xs-6 shop-item-width" hidden>
										<div class="single-item-Wrapper">
											<div class="shop-img-item">
								...
								<ul class="Blog-pages-button clear-fix">
									<li><a href="#">1</a></li>
									<li><a href="#">2</a></li>
									<li><a href="#">3</a></li>
									<li><a href="#">next</a></li>
